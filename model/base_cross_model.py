...
class CrossAttentionLayer(nn.Module):
    """Cross-attention layer with MLP."""
...
class PerceiveEncoder(nn.Module):
    """Perceiver-style encoder with cross-attention and self-attention."""
...
class PerceiveDecoder(nn.Module):
    """Perceiver-style decoder with cross-attention."""
